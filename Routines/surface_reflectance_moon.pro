...
for it = 0,n_elements(time_array_et)-1 do begin
  ...
  if ind_ok ne !null then begin
    ...
    for ipix = 0,n_pix-1 do MinnAlbedoLoc_AP[ipix] = mean(MinnScaled_Albedo[ilon_AP2[ipix]-d_cells[ipix]:ilon_AP2[ipix]+d_cells[ipix], ilat_AP[ipix]-d_cells[ipix]:ilat_AP[ipix]+d_cells[ipix]])
    ...
    for ipix = 0,n_pix-1 do albedo_UV_AP[ipix] = mean(alb_UV_shifted_AP[ilon_AP2[ipix]-d_cells[ipix]:ilon_AP2[ipix]+d_cells[ipix], ilat_AP[ipix]-d_cells[ipix]:ilat_AP[ipix]+d_cells[ipix]])
  ...
  if ind_ok ne !null then begin
    ...
    for ipix = 0,n_pix-1 do MinnAlbedoLoc_SP[ipix] = mean(MinnScaled_Albedo[ilon_SP2[ipix]-d_cells[ipix]:ilon_SP2[ipix]+d_cells[ipix], ilat_SP[ipix]-d_cells[ipix]:ilat_SP[ipix]+d_cells[ipix]])
    ...
    for ipix = 0,n_pix-1 do albedo_UV_SP[ipix] = mean(alb_UV_shifted_SP[ilon_SP2[ipix]-d_cells[ipix]:ilon_SP2[ipix]+d_cells[ipix], ilat_SP[ipix]-d_cells[ipix]:ilat_SP[ipix]+d_cells[ipix]])
