...
;       add rows v10-v21 T. Greathouse September 2011
;       add rows v22-v50 T. Greathouse June 2013
;-
;---------------------------------------------------------------------
 ...
 sz = size(file_or_fcb)
 if sz[sz[0]+1] NE 20 then fits_open,file_or_fcb,fcb else fcb=file_or_fcb
 ...
 if N_elements(rows) NE 0 then begin
        ...
        xrow = -1
 endelse
 if sz[sz[0]+1] NE 20 then fits_close,fcb else $
