pro readcol_ext,name,v1,v2,v3,v4,v5,v6,v7,v8,v9,$
...
;
; PROCEDURES CALLED
;       GETTOK(), FILE_LINES(), STRNUMBER()
;       The version of STRNUMBER() must be after August 2006.
; NOTES:
;       Under V7.1 or later, READCOL uses the SCOPE_VARFETCH function rather 
...
;       Call FILE_LINES() instead of NUMLINES() function  T. Dupuy   Nov 2015
;-
